...
#################################################################################
{
  "name"                 :  "Magento 2 Connector for Multichannel",
  "summary"              :  "Integrate Magento 2 marketplace with Odoo. Configure your Magento 2 store with Odoo. Manage orders, customers, products, etc at Odoo’s end. multi channel multi-channel magento2 multichannel magento2 bridge magento2 connector magento2 odoo bridge odoo magento2 magento 2 multichannel magento 2 bridge magento 2 connector magento 2 odoo bridge odoo magento 2 magento multichannel magento bridge magento connector magento odoo bridge odoo magento extensions for multichannel",
  "category"             :  "Website",
  "version"              :  "2.2.2",
  "sequence"             :  1,
  ...
  "description"          :  """https://webkul.com/blog/odoo-multichannel-magento2x-connector/
